...
let
atomic_forty_two = AtomicI64::new(
42
);
1.75.0 (const: 1.84.0)
·
...
ptr:
*mut
i64 = Box::into_raw(Box::new(
0
));
assert!
(ptr.cast::<AtomicI64>().is_aligned());
...
AtomicI64::compare_exchange_weak
,
