...
let
atomic_forty_two = AtomicU32::new(
42
);
1.75.0 (const: 1.84.0)
·
...
ptr:
*mut
u32 = Box::into_raw(Box::new(
0
));
assert!
(ptr.cast::<AtomicU32>().is_aligned());
