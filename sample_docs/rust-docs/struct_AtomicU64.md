...
let
atomic_forty_two = AtomicU64::new(
42
);
1.75.0 (const: 1.84.0)
·
...
ptr:
*mut
u64 = Box::into_raw(Box::new(
0
));
assert!
(ptr.cast::<AtomicU64>().is_aligned());
